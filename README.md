...
[![CircleCI](https://circleci.com/gh/simonsdave/cloudfeaster/tree/release-0.9.32.svg?style=shield)](https://circleci.com/gh/simonsdave/cloudfeaster/tree/release-0.9.32)
...
[This](https://github.com/simonsdave/cloudfeaster/tree/release-0.9.32/docs/story.md) is the story behind Cloudfeaster.

## What Next

* [this](https://github.com/simonsdave/cloudfeaster/tree/release-0.9.32/docs/spider_authors.md) describes
how to author spiders using Cloudfeaster
* see [these](https://github.com/simonsdave/cloudfeaster/tree/release-0.9.32/docs/contributing.md) instructions

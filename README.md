...
[![CircleCI](https://circleci.com/gh/simonsdave/cloudfeaster/tree/release-0.9.25.svg?style=shield)](https://circleci.com/gh/simonsdave/cloudfeaster/tree/release-0.9.25)
...
[This](https://github.com/simonsdave/cloudfeaster/tree/release-0.9.25/docs/story.md) is the story behind Cloudfeaster.

## What Next

* [this](https://github.com/simonsdave/cloudfeaster/tree/release-0.9.25/docs/spider_authors.md) describes
how to author spiders using Cloudfeaster
* see [these](https://github.com/simonsdave/cloudfeaster/tree/release-0.9.25/docs/contributing.md) instructions

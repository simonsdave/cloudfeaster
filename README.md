...
[![CircleCI](https://circleci.com/gh/simonsdave/cloudfeaster/tree/release-0.9.16.svg?style=svg)](https://circleci.com/gh/simonsdave/cloudfeaster/tree/release-0.9.16)
...
[This](https://github.com/simonsdave/cloudfeaster/tree/release-0.9.16/docs/story.md) is the story behind Cloudfeaster.

## What Next

* see [these](https://github.com/simonsdave/cloudfeaster/tree/release-0.9.16/docs/contributing.md) instructions
describe how to setup your development environment and
start contributing to Cloudfeaster
* [this](https://github.com/simonsdave/cloudfeaster/tree/release-0.9.16/docs/spider_authors.md) describes

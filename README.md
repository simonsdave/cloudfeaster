...
[![Requirements](https://requires.io/github/simonsdave/cloudfeaster/requirements.svg?branch=release-0.9.12)](https://requires.io/github/simonsdave/cloudfeaster/requirements/?branch=release-0.9.12)
[![Build Status](https://travis-ci.org/simonsdave/cloudfeaster.svg?branch=release-0.9.12)](https://travis-ci.org/simonsdave/cloudfeaster)
...
[This](https://github.com/simonsdave/cloudfeaster/tree/release-0.9.12/docs/story.md) is the story behind Cloudfeaster.

## What Next

* see [these](https://github.com/simonsdave/cloudfeaster/tree/release-0.9.12/docs/contributing.md) instructions
describe how to setup your development environment and
start contributing to Cloudfeaster
* [this](https://github.com/simonsdave/cloudfeaster/tree/release-0.9.12/docs/spider_authors.md) describes
